    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">
            Real-time resource metering, hourly prepaid balance drawdowns, and itemized VAT tax invoices.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="p-5 rounded-lg bg-white dark:bg-[#161922] border border-slate-200 dark:border-[#232736]">
          ...
          <span className="text-[11px] text-slate-500 dark:text-slate-500 mt-1 block">Accrued across all running instances</span>
        </div>

        <div className="p-5 rounded-lg bg-white dark:bg-[#161922] border border-slate-200 dark:border-[#232736]">
          <span className="text-xs font-medium text-slate-500 dark:text-slate-400 uppercase">Projected Month-End</span>
          <div className="mt-2 text-2xl font-mono font-semibold text-slate-900 dark:text-slate-100">
            ${(monthlyRetail * 1.06).toFixed(2)}
          </div>
          <span className="text-[11px] text-slate-500 dark:text-slate-500 mt-1 block">Forecasted based on 30-day burn rate</span>
        </div>

        <div className="p-5 rounded-lg bg-white dark:bg-[#161922] border border-slate-200 dark:border-[#232736]">
          <span className="text-xs font-medium text-slate-500 dark:text-slate-400 uppercase">Committed Tier & SLA</span>
          <div className="mt-2 text-2xl font-mono font-semibold text-blue-600 dark:text-blue-400">
            Enterprise
          </div>
          <span className="text-[11px] text-emerald-600 dark:text-emerald-400 mt-1 block font-medium">15% Committed Discount Active</span>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="p-5 rounded-lg bg-white dark:bg-[#161922] border border-slate-200 dark:border-[#232736] space-y-2">
            ...
            <div className="pt-2 flex items-center justify-between font-mono text-xs">
              <span className="text-slate-500 dark:text-slate-400">Dedicated Fleet: 4 nodes</span>
              <span className="text-blue-600 dark:text-blue-400 font-semibold">$72.00/mo ($0.10/hr)</span>
            </div>
          </div>
          ...
          <div className="p-5 rounded-lg bg-white dark:bg-[#161922] border border-slate-200 dark:border-[#232736] space-y-2">
            ...
            <div className="pt-2 flex items-center justify-between font-mono text-xs">
              <span className="text-slate-500 dark:text-slate-400">Production Clusters: 2 HA</span>
              <span className="text-blue-600 dark:text-blue-400 font-semibold">$187.00/mo</span>
            </div>
          </div>
          ...
          <div className="p-5 rounded-lg bg-white dark:bg-[#161922] border border-slate-200 dark:border-[#232736] space-y-2">
            ...
            <div className="pt-2 flex items-center justify-between font-mono text-xs">
              <span className="text-slate-500 dark:text-slate-400">NVMe (850GB) + S3 (2.5TB)</span>
              <span className="text-blue-600 dark:text-blue-400 font-semibold">$246.00/mo</span>
            </div>
          </div>
          ...
          <div className="p-5 rounded-lg bg-white dark:bg-[#161922] border border-slate-200 dark:border-[#232736] space-y-2">
            ...
            <div className="pt-2 flex items-center justify-between font-mono text-xs">
              <span className="text-slate-500 dark:text-slate-400">Active Zones: 2 domains</span>
              <span className="text-blue-600 dark:text-blue-400 font-semibold">$5.83/mo</span>
            </div>
          </div>
        </div>
      )}
          ...
          <table className="w-full text-left text-xs">
            <thead className="bg-slate-50 dark:bg-[#11131A] text-slate-500 dark:text-slate-400 uppercase tracking-wider font-medium text-[11px] border-b border-slate-200 dark:border-[#232736]">
              <tr>
                ...
                <th className="py-2.5 px-4 text-right">Receipt / Tax PDF</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-slate-200 dark:divide-[#232736] font-mono text-xs">
              {invoices.map((inv) => (
                <tr key={inv.id} className="hover:bg-slate-50/60 dark:hover:bg-white/[0.02]">
                  ...
                  <td className="py-3 px-4">
                    <span className="text-[10px] font-mono text-emerald-700 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-500/10 border border-emerald-200 dark:border-emerald-500/20 px-2 py-0.5 rounded">
                      PAID IN FULL
                    </span>
                  </td>
                  <td className="py-3 px-4 text-right">
