    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <Link
            href="/compute"
            className="h-8 px-3 rounded-md bg-[#161922] hover:bg-[#1E2230] border border-[#232736] text-xs font-medium text-slate-300 hover:text-white flex items-center gap-1.5 transition-colors"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {/* Card 1: Droplets */}
        <div className="p-5 rounded-lg bg-[#161922] border border-[#232736] flex flex-col justify-between">
          <div className="flex items-center justify-between">
        ...
        <div className="p-5 rounded-lg bg-[#161922] border border-[#232736] flex flex-col justify-between">
          ...
          <div className="mt-3 flex items-baseline gap-2">
            <span className="text-2xl font-semibold text-slate-100">{databases.length}</span>
        ...
        <div className="p-5 rounded-lg bg-[#161922] border border-[#232736] flex flex-col justify-between">
          ...
          <div className="mt-3 flex items-baseline gap-2">
            <span className="text-2xl font-semibold text-slate-100">{totalStorageGb} GB</span>
            <span className="text-xs text-blue-400 font-medium">NVMe + S3</span>
          </div>
      ...
      <div className="p-5 rounded-lg bg-[#161922] border border-[#232736] space-y-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <Activity className="w-4 h-4 text-blue-400" />
            <h2 className="text-sm font-semibold text-slate-200">Cluster Telemetry & Load</h2>
      ...
      <div className="rounded-lg bg-[#161922] border border-[#232736] overflow-hidden">
        <div className="p-4 border-b border-[#232736] flex items-center justify-between">
          <h3 className="text-sm font-semibold text-slate-200">Active Droplet Nodes</h3>
          <Link href="/compute" className="text-xs text-blue-400 hover:text-blue-300 font-medium">
              ...
              {filteredInstances.map((inst) => (
                <tr key={inst.id} className="hover:bg-white/[0.02] transition-colors">
                  ...
                  <td className="py-3 px-4 font-mono">
                    <span className="text-slate-300 block">{inst.ipv4}</span>
                  ...
                  <td className="py-3 px-4">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[11px] font-mono text-slate-400">{inst.currentCpu}%</span>
                    </div>
                  </td>
                  <td className="py-3 px-4 text-right">
                    <button
                      onClick={() => setTerminalInstance(inst)}
                      className="h-7 px-2.5 rounded bg-[#1E2230] hover:bg-[#252B3D] border border-[#232736] text-[11px] text-slate-300 hover:text-white inline-flex items-center gap-1.5 transition-colors cursor-pointer"
                    >
